package it.prova.gestioneloginutenteautomobile.web.listner;
...
public class LocalEntityManagerFactoryListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent sce) {
		try {
			entityManagerFactory = Persistence.createEntityManagerFactory("gestioneloginutenteautomobile_unit");
		} catch (Throwable ex) {
